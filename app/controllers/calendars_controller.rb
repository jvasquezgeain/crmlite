class CalendarsController < ApplicationController
  ...
  private
    ...
    def calendar_params
      params.require(:calendar).permit(:company, :contact, :job_title, :type_customer, :type_scheduled, :assigned_by_id, :agent_id, :day, :hour, :address, :phone, :observation, :stated_at)
    end
end
